      ...
      <div className="container py-6 md:py-10">
        ...
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-gray-500 mb-4">Agrega productos para continuar con tu compra</p>
            <Link href="/catalog">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                          ...
                          <div className="mt-4 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              ...
                              <div className="space-y-1">
                                ...
                                <Input id="postal" placeholder="CP" />
                              </div>
                            </div>
                          </div>
                        )}
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 rounded-lg border overflow-hidden">
                <div className="bg-gray-50 p-4">
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-lg">MX${total.toLocaleString()}</span>
                  </div>
