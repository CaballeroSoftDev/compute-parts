// Script para probar que las políticas RLS están corregidas
// Ejecutar con: node scripts/test-rls-fixed.js
...
async function testRLSFixed() {
  try {
    console.log('🚀 Iniciando prueba de políticas RLS corregidas...\n');
    ...
    const paymentData = {
      paypal_order_id: 'TEST-RLS-FIXED-123',
      orderData: {
        user_id: user.id,
    ...
    // 5. Resumen del flujo
    console.log('\n🎉 Resumen de las políticas RLS corregidas:');
    console.log('✅ Políticas RLS: Corregidas y funcionando');
    console.log('✅ Inserción de órdenes: Permitida');
    console.log('✅ Consulta de órdenes: Funcionando');
    console.log('✅ Actualización de órdenes: Permitida');
    ...
    console.log('4. Las políticas RLS ya están corregidas y funcionando');
  } catch (error) {
    ...
    console.log('4. Las políticas RLS ya están corregidas');
  }
}
