      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            ...
            <CardTitle className="text-center text-2xl font-bold">Verificando Enlace</CardTitle>
            <CardDescription className="text-center">Estamos verificando tu enlace de recuperación...</CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <div className="mb-4 flex justify-center">
              <div className="h-8 w-8 animate-spin rounded-full border-b-2 border-[#007BFF]"></div>
            </div>
            <p className="text-sm text-gray-600">Por favor espera mientras verificamos que tu enlace sea válido.</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            ...
            <CardTitle className="text-center text-2xl font-bold">Enlace de Recuperación Inválido</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-4 text-center">
              ...
              <div className="space-y-3 pt-4">
                ...
                >
                  <Link href="/recover">Solicitar nuevo enlace de recuperación</Link>
                </Button>
                ...
                {password && (
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1 text-xs text-gray-500">
                      <div
                        className={`flex items-center space-x-1 ${password.length >= 8 ? 'text-green-600' : 'text-gray-400'}`}
                      >
                        {password.length >= 8 ? <ShieldCheck className="h-3 w-3" /> : <ShieldX className="h-3 w-3" />}
                        <span>Al menos 8 caracteres</span>
                      </div>
                      <div
                        className={`flex items-center space-x-1 ${/[a-z]/.test(password) ? 'text-green-600' : 'text-gray-400'}`}
                      >
                      ...
                      <div
                        className={`flex items-center space-x-1 ${/\d/.test(password) ? 'text-green-600' : 'text-gray-400'}`}
                      >
