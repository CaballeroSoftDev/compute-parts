      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            ...
            <CardTitle className="text-center text-2xl font-bold">Verificación Pendiente</CardTitle>
            <CardDescription className="text-center">Tu cuenta necesita ser verificada para continuar</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start gap-2 text-sm text-gray-600">
              <span>
                Revisa tu bandeja de entrada y haz clic en el enlace de verificación para activar tu cuenta y poder
                iniciar sesión.
              </span>
            </div>
